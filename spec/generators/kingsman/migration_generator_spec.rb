...
require "generators/kingsman/migration_generator"

describe Kingsman::MigrationGenerator, type: :generator do
  it_behaves_like "a generator" do
    let(:migration_name) { "db/migrate/add_kingsman_to_bacon_transitions.rb" }
  end

  describe "the model contains the correct words" do
    subject(:migration) do
      file(
        "db/migrate/#{migration_number}_add_kingsman_to_bacon_transitions.rb",
      )
    end
