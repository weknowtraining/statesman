...
require "kingsman/exceptions"

describe Kingsman::Adapters::ActiveRecord, active_record: true do
  before do
    prepare_model_table
    ...
    Kingsman.configure do
      ...
      storage_adapter(Kingsman::Adapters::ActiveRecord)
  ...
  let(:observer) { double(Kingsman::Machine, execute: nil) }
  ...
  describe "#initialize" do
    context "with unserialized metadata and non json column type" do
      ...
      it "raises an exception" do
        ...
        end.to raise_exception(Kingsman::UnserializedMetadataError)
      end
    end
    ...
    context "with serialized metadata and json column type" do
      ...
      it "raises an exception" do
        expect do
          described_class.new(MyActiveRecordModelTransition,
                              MyActiveRecordModel, observer)
        end.to raise_exception(Kingsman::IncompatibleSerializationError)
      end
    end
    ...
    context "when there is a race" do
      it "raises a TransitionConflictError" do
        ...
        expect { adapter.create(:y, :z) }.
          to raise_exception(Kingsman::TransitionConflictError)
      end
    end
